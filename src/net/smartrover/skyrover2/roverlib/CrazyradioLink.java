 ...
 *  > https://github.com/bitcraze/crazyflie-android-client/blob/master/src/se/bitcraze/crazyflielib/CrazyradioLink.java
 */
...
/**
 * @see http://wiki.bitcraze.se/projects:crazyradio:protocol
...
public class CrazyradioLink extends AbstractLink {
    ...
    //private static final int REQUEST_SET_RADIO_POWER = 0x04; // not used
    private static final int REQUEST_SET_RADIO_ARD = 0x05;
    private static final int REQUEST_SET_RADIO_ARC = 0x06;
    //private static final int REQUEST_ACK_ENABLE = 0x10; // not used
    ...
    //private static final int REQUEST_LAUNCH_BOOTLOADER = 0xFF; // not used
