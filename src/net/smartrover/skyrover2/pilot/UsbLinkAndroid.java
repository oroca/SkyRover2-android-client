 ...
 *  > https://github.com/bitcraze/crazyflie-android-client/blob/master/src/se/bitcraze/crazyfliecontrol2/UsbLinkAndroid.java
 */

package net.smartrover.skyrover2.pilot;

import net.smartrover.skyrover2.roverlib.CrazyradioLink;
import net.smartrover.skyrover2.roverlib.IUsbLink;
...
public class UsbLinkAndroid implements IUsbLink {
    ...
    /* (non-Javadoc)
     * @see net.smartrover.skyrover2.roverlib.IUsbLink#isUsbConnected()
     */
