 ...
 *  > https://github.com/bitcraze/crazyflie-android-client/blob/master/src/se/bitcraze/crazyfliecontrol2/MainActivity.java
 */

package net.smartrover.skyrover2.pilot;

import net.smartrover.skyrover2.pilot.controller.Controls;
import net.smartrover.skyrover2.pilot.controller.GamepadController;
import net.smartrover.skyrover2.pilot.controller.GyroscopeController;
import net.smartrover.skyrover2.pilot.controller.IController;
import net.smartrover.skyrover2.pilot.controller.TouchController;
import net.smartrover.skyrover2.pilot.prefs.PreferencesActivity;
import net.smartrover.skyrover2.roverlib.BleLink;
import net.smartrover.skyrover2.roverlib.ConnectionAdapter;
import net.smartrover.skyrover2.roverlib.CrazyradioLink;
import net.smartrover.skyrover2.roverlib.Link;
import net.smartrover.skyrover2.roverlib.crtp.CommanderPacket;
...
public class MainActivity extends Activity {
    ...
    private static final String LOG_TAG = "SkyRover2Control";
    ...
    public void onBackPressed() {
        ...
        Toast.makeText(this, R.string.msg_on_exit, Toast.LENGTH_SHORT).show();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (UsbManager.ACTION_USB_DEVICE_ATTACHED.equals(action)) {
                ...
                if (device != null && UsbLinkAndroid.isCrazyradio(device)) {
                    ...
                    Toast.makeText(MainActivity.this, R.string.msg_crazyradio_attached, Toast.LENGTH_SHORT).show();
            ...
            mLink.addConnectionListener(new ConnectionAdapter() {
                ...
                public void connectionInitiated(Link l) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), R.string.msg_connecting, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                ...
                public void disconnected(Link l) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), R.string.msg_disconnected, Toast.LENGTH_SHORT).show();
                ...
                public void connectionSetupFinished(Link l) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), R.string.msg_connected , Toast.LENGTH_SHORT).show();
                ...
                public void connectionLost(Link l) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), R.string.msg_conn_lost, Toast.LENGTH_SHORT).show();
                            mToggleConnectButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.custom_button));
                        }
                    });
                    linkDisconnect();
                ...
                public void connectionFailed(Link l) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), R.string.msg_conn_failed, Toast.LENGTH_SHORT).show();
                        }
                    });
                    linkDisconnect();
                }
