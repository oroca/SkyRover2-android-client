 ...
 *  > https://github.com/bitcraze/crazyflie-android-client/blob/master/src/se/bitcraze/crazyfliecontrol/controller/AbstractController.java
 */
...
public abstract class AbstractController implements IController {
	...
	public void enable(){
		mIsDisabled = false;
		Toast.makeText(mActivity, getControllerName() + " " + mActivity.getResources().getString(R.string.msg_using), Toast.LENGTH_SHORT).show();
	}
    ...
    /*
     * Absolute thrust value (gets send to the SkyRover2)
     */
