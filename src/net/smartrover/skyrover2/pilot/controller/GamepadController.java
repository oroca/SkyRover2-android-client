 ...
 *  > https://github.com/bitcraze/crazyflie-android-client/blob/master/src/se/bitcraze/crazyfliecontrol/controller/GamepadController.java
 */
...
public class GamepadController extends AbstractController {
    ...
    public String getControllerName(){
    	return mActivity.getResources().getString(R.string.name_gamepad_controller);
    }
    ...
    public void dealWithKeyEvent(KeyEvent event){
        ...
        case KeyEvent.ACTION_DOWN:
            if(event.getKeyCode() == mEmergencyBtn){
                ...
                if (mActivity.getSkyRoverLink() != null) {
                    mActivity.linkDisconnect();
                }
                Toast.makeText(mActivity, R.string.msg_emergency_stop, Toast.LENGTH_SHORT).show();
     ...
     * Handles split axis
     * (non-Javadoc)
     * @see net.smartrover.skyrover2.pilot.controller.AbstractController#getYaw()
     */
    @Override
    public float getYaw() {
        float yaw = 0;
