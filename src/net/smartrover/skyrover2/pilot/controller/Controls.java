 ...
 *  > https://github.com/bitcraze/crazyflie-android-client/blob/master/src/se/bitcraze/crazyfliecontrol/controller/Controls.java
 */
...
import net.smartrover.skyrover2.pilot.FlightDataView;
...
public class Controls {
    ...
    private boolean mXmode; // determines SkyRover2 flight configuration (false = +, true = x)
